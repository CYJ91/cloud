...
--
-- Current Database: `CYJ`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `CYJ` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `CYJ`;

--
-- Table structure for table `tbCYJ`
--

DROP TABLE IF EXISTS `tbCYJ`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbCYJ` (
  `num` int(10) DEFAULT NULL,
  `name` char(10) DEFAULT NULL,
  `addr` char(10) DEFAULT NULL,
  `phone` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbCYJ`
--

LOCK TABLES `tbCYJ` WRITE;
/*!40000 ALTER TABLE `tbCYJ` DISABLE KEYS */;
INSERT INTO `tbCYJ` VALUES (1,'choi','IC',1023123);
/*!40000 ALTER TABLE `tbCYJ` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `xe_addons_site` VALUES (0,'autolink','Y','N',NULL,'20231117113129'),(0,'member_communication','Y','N',NULL,'20231117113129'),(0,'member_extra_info','Y','N',NULL,'20231117113129'),(0,'resize_image','Y','N',NULL,'20231117113129');
...
INSERT INTO `xe_layouts` VALUES (88,0,'xedition','XEDITION','O:8:\"stdClass\":3:{s:3:\"GNB\";i:64;s:3:\"UNB\";i:75;s:3:\"FNB\";i:78;}',NULL,0,'20231117113131','P'),(89,0,'default','welcome_mobile_layout','O:8:\"stdClass\":4:{s:3:\"GNB\";i:64;s:3:\"UNB\";i:75;s:3:\"FNB\";i:78;s:9:\"main_menu\";i:64;}',NULL,0,'20231117113131','M');
...
INSERT INTO `xe_member` VALUES (4,'admin','sp8081@naver.com','sha256:0008192:0DaMFzqgeVaD:O3nfMY7PjMGre+VeYM7/motBgwQLZA8A','sp8081','naver.com','admin','admin',NULL,NULL,'','',NULL,'N','Y','N',NULL,'20231117113128','20231117113128','20231117113128','Y',NULL,NULL,-4);
...
INSERT INTO `xe_member_denied_user_id` VALUES ('addon','20231117113128','',-5),('admin','20231117113128','',-6),('adminlogging','20231117113128','',-7),('autoinstall','20231117113128','',-8),('board','20231117113128','',-9),('comment','20231117113128','',-10),('communication','20231117113128','',-11),('counter','20231117113128','',-12),('document','20231117113128','',-13),('editor','20231117113128','',-14),('file','20231117113128','',-15),('importer','20231117113128','',-16),('install','20231117113128','',-17),('integration_search','20231117113128','',-18),('krzip','20231117113128','',-19),('layout','20231117113128','',-20),('member','20231117113128','',-21),('menu','20231117113128','',-22),('message','20231117113128','',-23),('module','20231117113128','',-24),('page','20231117113128','',-25),('point','20231117113128','',-26),('poll','20231117113128','',-27),('rss','20231117113128','',-28),('seo','20231117113128','',-29),('session','20231117113128','',-30),('spamfilter','20231117113128','',-31),('tag','20231117113128','',-32),('trash','20231117113128','',-33),('widget','20231117113128','',-34),('www','20231117113128','',-35),('root','20231117113128','',-36),('administrator','20231117113128','',-37),('telnet','20231117113128','',-38),('ftp','20231117113128','',-39),('http','20231117113128','',-40);
...
INSERT INTO `xe_member_group` VALUES (0,1,1,'관리그룹','20231117113128','N','Y','',''),(0,2,2,'준회원','20231117113128','Y','N','',''),(0,3,3,'정회원','20231117113128','N','N','','');
...
INSERT INTO `xe_member_group_member` VALUES (0,1,4,'20231117113128');
...
INSERT INTO `xe_menu` VALUES (64,0,'Main menu',-64,'20231117113129'),(75,0,'Utility menu',-75,'20231117113130'),(78,0,'Footer Menu',-78,'20231117113130');
...
INSERT INTO `xe_menu_item` VALUES (66,0,64,'Welcome Page','','index','N','N','N',NULL,NULL,NULL,NULL,-66,'20231117113129'),(68,0,64,'Board','','board','N','N','N',NULL,NULL,NULL,NULL,-68,'20231117113129'),(69,68,64,'SAMPLE 1','','#','Y','N','N',NULL,NULL,NULL,NULL,-69,'20231117113129'),(70,69,64,'SAMPLE 1-1','','#','Y','N','N',NULL,NULL,NULL,NULL,-70,'20231117113129'),(71,68,64,'SAMPLE 2','','#','Y','N','N',NULL,NULL,NULL,NULL,-71,'20231117113129'),(72,68,64,'SAMPLE 3','','#','Y','N','N',NULL,NULL,NULL,NULL,-72,'20231117113129'),(74,0,64,'XEIcon','','xeicon','N','N','N',NULL,NULL,NULL,NULL,-74,'20231117113129'),(76,0,75,'XE Official Site','','http://www.xpressengine.com','Y','N','N',NULL,NULL,NULL,NULL,-76,'20231117113130'),(77,0,75,'GitHub','','https://github.com/xpressengine','Y','N','N',NULL,NULL,NULL,NULL,-77,'20231117113130'),(79,0,78,'Welcome Page','','#','Y','N','N',NULL,NULL,NULL,NULL,-79,'20231117113130'),(80,79,78,'SAMPLE 1','','#','Y','N','N',NULL,NULL,NULL,NULL,-80,'20231117113130'),(81,79,78,'SAMPLE 2','','#','Y','N','N',NULL,NULL,NULL,NULL,-81,'20231117113130'),(82,79,78,'SAMPLE 3','','#','Y','N','N',NULL,NULL,NULL,NULL,-82,'20231117113130'),(83,0,78,'Board','','#','Y','N','N',NULL,NULL,NULL,NULL,-83,'20231117113130'),(84,83,78,'SAMPLE 1','','#','Y','N','N',NULL,NULL,NULL,NULL,-84,'20231117113130'),(85,83,78,'SAMPLE 2','','#','Y','N','N',NULL,NULL,NULL,NULL,-85,'20231117113131'),(86,0,78,'XEIcon','','#','Y','N','N',NULL,NULL,NULL,NULL,-86,'20231117113131'),(87,86,78,'SAMPLE 1','','#','Y','N','N',NULL,NULL,NULL,NULL,-87,'20231117113131');
...
INSERT INTO `xe_module_extra_vars` VALUES (65,'regdate','20231117113129'),(73,'regdate','20231117113129'),(65,'page_type','WIDGET'),(73,'page_type','WIDGET');
...
INSERT INTO `xe_sites` VALUES (0,65,'www.gusiya.com/xe/','ko','20231117113128');
...
INSERT INTO `db` VALUES ('%','test','','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','N','N','Y','Y'),('%','test\\_%','','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','N','N','Y','Y'),('%','blackdb','admin','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y'),('%','CYJ','CYJ','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y');
...
INSERT INTO `proxies_priv` VALUES ('localhost','root','','',1,'','2023-11-17 11:02:05'),('ns.gusiya.com','root','','',1,'','2023-11-17 11:02:05');
...
LOCK TABLES `tbinfo` WRITE;
/*!40000 ALTER TABLE `tbinfo` DISABLE KEYS */;
INSERT INTO `tbinfo` VALUES (1,'choi','IC',1023123);
...
INSERT INTO `user` VALUES ('localhost','root','*522D20E8BA620760F96F52AE32AD91F8F22BEC57','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('ns.gusiya.com','root','*522D20E8BA620760F96F52AE32AD91F8F22BEC57','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('127.0.0.1','root','*522D20E8BA620760F96F52AE32AD91F8F22BEC57','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('::1','root','*522D20E8BA620760F96F52AE32AD91F8F22BEC57','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('%','CYJ','*F9D88FB558834EEE07383E1D411702F21016C419','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('%','who','*21A8A9C5AF56427E80979AD88427A088AAA24306','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'','');
...
-- Dump completed on 2023-11-17 20:35:37
